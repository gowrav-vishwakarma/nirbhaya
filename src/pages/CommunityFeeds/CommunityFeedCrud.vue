        ...
        <q-form @submit="onSubmit" class="q-gutter-md">
          ...
          <div v-if="form.mediaUrls.length" class="row q-gutter-sm">
            ...
            >
              <q-img
                :src="url"
                style="height: 140px; width: 140px; border-radius: 8px"
              >
          ...
          <q-select
            ...
            :options="['general', 'emergency', 'alert', 'news']"
            label="Category"
          />
...
async function onSubmit() {
  try {
    ...
    $q.notify({
      color: 'negative',
      message: 'Failed to create or update feed',
      position: 'top-right',
    });
  } finally {
    loading.value = false;
