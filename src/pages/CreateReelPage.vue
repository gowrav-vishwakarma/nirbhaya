  ...
  <q-page class="create-reel-page">
    ...
    <q-page-sticky position="bottom" :offset="[0, 18]">
      <q-btn-group spread>
        ...
        />
        <q-btn
          v-else-if="isPlayingRecordedVideo && isVideoReady"
          color="secondary"
          icon="play_arrow"
          label="Play"
        ...
        <q-btn
          ...
          @click="toggleSecondaryCamera"
          :disable="
            isRecording || isPlayingRecordedVideo || availableCameras.length < 2
          "
        />
        <q-btn
          color="positive"
...
.video-container {
  ...
  height: calc(
    100% - 70px
  ); // Adjust this value based on your button group height
  overflow: hidden;
}
