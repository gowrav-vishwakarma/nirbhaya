<template>
  <div>
    ...
    <div class="flex flex-wrap justify-evenly gap-4 px-4 py-2 py-2 q-py-sm">
      <div class="flex items-start justify-start gap-2" :style="{ width: post.isBusinessPost ? '25%' : '30%' }">
      ...
      <div class="flex items-center justify-center gap-2" :style="{ width: post.isBusinessPost ? '25%' : '30%' }">
      ...
      <div v-if="post.isBusinessPost" class="flex items-center justify-center gap-2"
      ...
      <div v-if="showShareButton" class="flex items-center justify-center gap-2"
        :style="{ width: post.isBusinessPost ? '25%' : '40%' }">
...
const allowedShareIds = process.env.VITE_SHOW_INSTALL_PROMPT?.split(',').map((id: string) => parseInt(id)) || [];
