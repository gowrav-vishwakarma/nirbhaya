    ...
    <div class="container">
      ...
      <div class="controls q-mt-md">
        <div class="flex justify-center">
          <q-btn
            color="primary"
            style="margin: auto; width: 100%; border-radius: 10px !important"
          ...
          >
            ...
            ></i>
            <span style="font-size: 12px; font-weight: 900; margin-left: 10px"
              >Download</span
            >
          </q-btn>
...
const initStage = () => {
  ...
  image.onload = () => {
    ...
    const referralText = new Konva.Text({
      ...
      x: 0,
      y: viewportHeight * 0.13, // Position relative to viewport height
