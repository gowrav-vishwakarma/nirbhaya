export default {
  ...
  autoNotifyNearbyAfterDelay:
    'नज़दीकी व्यक्तियों को यदि कोई संपर्क नहीं जोड़ता है तो 1 मिनट में सूचित करें',
  // Profile Page
  ...
  student: 'विद्यार्थी',
  nurse: 'नियुस',
  freelancer: 'फ्रीलांसिंग',
  onlineSeller: 'ऑनलाइन विक्रेता',
  handicraftMaker: 'हेंडीक्राफ्ट निर्माता',
  tailor: 'दरजी',
  beautician: 'सौंदर्य विशेषज्ञ',
  foodSeller: 'फ़ूड विक्रेता',
  artsMediaDesigner: 'कला, मीडिया और डिज़ाइन निर्माता',
  skilledTradesWorker: 'कुशल श्रमिक',
  shopOwner: 'दुकानदार',
  techITProfessional: 'तकनीकी और IT प्रोफेशनल',
  healthcareMedicalWorker: 'स्वास्थ्य और चिकित्सा कर्मचारी',
  socialWorker: 'सामाजिक कार्यकर्ता',
  privateSectorEmployee: 'प्राइवेट क्षेत्र के कर्मचारी',
  governmentEmployee: 'सरकारी कर्मचारी',
  businessOwner: 'व्यापारी',
  housewife: 'गृहिणी',
  retired: 'सेवानिवृत्त',
  unemployed: 'बेरोजगार',
  other: 'अन्य',
  ...
  whatsappNumberRequired: 'व्हाट्सएप नंबर आवश्यक है',
  invalidPhoneNumber: 'कृपया एक मान्य 10-अंकीय फोन नंबर दर्ज करें',
  businessLocationRequired: 'व्यवसाय स्थान आवश्यक है',
  businessInfoSaved: 'व्यवसाय जानकारी सफलतापूर्वक सहेजी गई',
  businessInfoError: 'व्यवसाय जानकारी सहेजने में विफल',
  businessInfoRemoved: 'व्यवसाय जानकारी सफलतापूर्वक हटा दी गई',
  businessInfoRemoveError: 'व्यवसाय जानकारी हटाने में विफल',
  confirmRemove: 'हटाने की पुष्टि करें',
  getCurrentLocation: 'वर्तमान स्थान प्राप्त करें',

  whatsappRequired: 'व्हाट्सएप नंबर आवश्यक है',
  phoneLength: 'फ़ोन नंबर 10 अंकों का होना चाहिए',
