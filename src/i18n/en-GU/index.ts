...
export default {
  ...
  locationSharingHelp:
    'સુરક્ષા હેતુઓ માટે તમે તમારું સ્થાન કેવી રીતે શેર કરવા માંગો છો તે પસંદ કરો.',
  ...
  alwaysLive: 'હંમેશા લાઈવ (દર 5 મિનિટે સ્થાન શેર કરો)',
  fetchSOS: 'દર 5 મિનિટે SOS ઘટનાઓ મેળવો',
  noLocationSharing: 'સ્થાન શેર કરશો નહીં',
  volunteerLocationSharing: 'સ્વયંસેવક ઉપલબ્ધતા',
  volunteerLocationSharingHelp:
    'જરૂરિયાતમંદોને મદદ કરવા માટે સ્વયંસેવક તરીકે તમે કેવી રીતે ઉપલબ્ધ થવા માંગો છો તે પસંદ કરો.',
  volunteerLocationSharingDescription:
    'સ્વયંસેવક તરીકે, તમે કટોકટીની પરિસ્થિતિઓમાં અન્યોને મદદ કરવા માટે તમારું સ્થાન શેર કરવાનું પસંદ કરી શકો છો. નીચે તમારો પસંદગીનો ઉપલબ્ધતા વિકલ્પ પસંદ કરો.',
  alwaysAvailable: 'હંમેશા ઉપલબ્ધ (દર 5 મિનિટે સ્થાન શેર કરો)',
  periodicallyCheck:
    'દર 5 મિનિટે SOS જાઁચ કરો, પરંતુ મારું સ્થાન સાચવવાનું નથી',
