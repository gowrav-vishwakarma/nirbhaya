export default {
  ...
  autoNotifyNearbyAfterDelay:
    'નજીકના વ્યક્તિઓને યાતરીમાં નથી તેવું જો તેઓ જોઈએ તો 1 મિનિટમાં સૂચિત કરો',
  // Profile Page
  ...
  onlyNumbersAllowed: 'ફક્ત સંખ્યાઓની જ મંજૂરી છે',
  invalidPhoneNumberLength: 'ફોન નંબર 10 અંકનો હોવો જોઈએ',
  unexpectedError: 'અણધાર્યા ભૂલ થઈ',
  cantAddOwnNumber: 'તમારો પોતાનો નંબર ઉમેરવા માટે નહીં',
  // Volunteering
  ...
  emergencyServices: 'આપાતકાળીન સેવાઓને કોલ કરો',
  police: 'પોલીસ',
  ...
  state: 'રાજ્ય',
  selectState: 'કૃપા કરીને પહેલા રાજ્ય પસંદ કરો',
  noCitiesFound: 'કોઈ શહેરો મળ્યા નથી',
  ...
  contactRemoved: 'સંપર્ક દૂર કરવામાં આવ્યો',

  sosButtonNote_label: 'SOS બટન દબાવીને તમારા આકસ્મિક સંપર્કોને જાણ કરો.',
  sosButtonNote_descTitle: 'SOS બટનનું વર્ણન:',
  sosButtonNote_H1: 'SOS બટન: ',
  sosButtonNote_H1Desc:
    'SOS બટન દબાવવાથી તમારા ઉમેરેલા આકસ્મિક સંપર્કોને એક સૂચના મોકલવામાં આવશે, જે તેમને તમારા SOS ઘટના અને સ્થાન (જો શેર કરવામાં આવ્યું હોય) વિશે જાણ કરશે.',
  sosButtonNote_H2: 'મહત્વપૂર્ણ નોંધ: ',
  ...
  autoNotifyNearbyDefaultDesc:
    'જ્યારે સક્ષમ હોય, જો 1 મિનિટની અંદર કોઈ સંપર્ક પ્રતિસાદ ન આપે તો SOS એલર્ટ આપમેળે નજીકના સ્વયંસેવકોને સૂચિત કરશે',
};
